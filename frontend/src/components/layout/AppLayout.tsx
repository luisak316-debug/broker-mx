...
import { PortalAtmosphere } from '../auth/PortalAtmosphere';
...
export function AppLayout() {
  ...
  return (
    <div className="portal-page app-page relative min-h-[100dvh] w-full max-w-[100dvw] overflow-x-hidden">
      <PortalAtmosphere />
      <div className="portal-shell relative z-10 flex min-h-[100dvh] w-full max-w-[100dvw] overflow-x-hidden">
        <Sidebar />
