# Restaura la landing Broker.mx al respaldo aprobado (leyenda hasta Nuestra firma) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-leyenda-hold\RESTORE.ps1
