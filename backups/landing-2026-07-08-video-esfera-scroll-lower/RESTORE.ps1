# Restaura la landing Broker.mx al respaldo aprobado (esfera baja + scroll tarjeta) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-video-esfera-scroll-lower\RESTORE.ps1
