...
import { CapitalGlobeVideoMini } from '../components/landing/capital-scroll/CapitalGlobeVideoMini';
...
export function Landing() {
  ...
  return (
    <div className="landing-page min-h-screen bg-black text-slate-100">
      ...
      <header className="relative z-40 sticky top-0 border-b border-white/10 bg-[#050202]/55 backdrop-blur-xl">
        ...
        <LandingCapitalScrolly
          hero={
            <section className="landing-hero landing-hero--globe relative">
              <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-10 pt-5 md:pt-8 lg:pt-10">
                <div className="cap-hero-stack">
