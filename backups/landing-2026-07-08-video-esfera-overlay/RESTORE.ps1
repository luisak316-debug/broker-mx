# Restaura la landing Broker.mx al respaldo aprobado (esfera detrás del vidrio) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-video-esfera-overlay\RESTORE.ps1
