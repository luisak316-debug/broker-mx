# Restaura la landing Broker.mx al respaldo aprobado (sin hueco Confianza → CTA) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-confianza-cta\RESTORE.ps1
