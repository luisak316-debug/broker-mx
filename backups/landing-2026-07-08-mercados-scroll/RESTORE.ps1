# Restaura la landing Broker.mx al respaldo aprobado (scroll mercados) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-mercados-scroll\RESTORE.ps1
