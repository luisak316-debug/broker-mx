# Restaura la landing Broker.mx al respaldo aprobado (esfera fija + tarjeta scroll) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-video-esfera-scroll\RESTORE.ps1
...
Write-Host "  npm run build:vercel"
