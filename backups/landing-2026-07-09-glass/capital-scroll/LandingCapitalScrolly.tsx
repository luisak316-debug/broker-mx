...
import { CapHeroScrollReveal } from './CapHeroScrollReveal';
...
export function LandingCapitalScrolly({ hero, afterHero }: Props) {
  ...
  return (
    <div ref={scrollRootRef} className="cap-scrolly" data-cap-scrolly data-cap-version="8">
      <div className="cap-scrolly__stage">
        <div className="cap-scrolly__stage-inner">
          <CapitalGlobeVideo />
        </div>
        <CapHeroScrollReveal scrollRootRef={scrollRootRef} />
      </div>
