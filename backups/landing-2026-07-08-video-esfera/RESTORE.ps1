# Restaura la landing Broker.mx al respaldo aprobado (vídeo esfera local) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-video-esfera\RESTORE.ps1
