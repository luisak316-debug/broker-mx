...
export function Landing() {
  ...
  return (
    <div className="landing-page min-h-screen bg-black text-slate-100">
      ...
      <header className="relative z-40 sticky top-0 border-b border-white/5 bg-[#050202]/80 backdrop-blur-md">
        ...
        <LandingCapitalScrolly
          hero={
            <section className="landing-hero landing-hero--globe relative">
              <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-8 pt-16 md:pt-20 lg:pt-24">
