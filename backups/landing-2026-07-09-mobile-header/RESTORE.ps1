# Restaura la landing Broker.mx al respaldo aprobado (header móvil estable) del 9 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-09-mobile-header\RESTORE.ps1
