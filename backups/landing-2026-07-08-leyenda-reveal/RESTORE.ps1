# Restaura la landing Broker.mx al respaldo aprobado (leyenda reveal detrás tarjeta) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-leyenda-reveal\RESTORE.ps1
