# Restaura la landing Broker.mx al respaldo aprobado (hero + trader scroll nativo) del 8 jul 2026.
# Uso: powershell -ExecutionPolicy Bypass -File backups\landing-2026-07-08-trader-scroll\RESTORE.ps1
