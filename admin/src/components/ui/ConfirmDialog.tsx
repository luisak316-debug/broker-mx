...
/**
 * Modal de confirmación para cambios financieros sensibles.
 * "¿Estás seguro de que deseas cambiar el saldo de este cliente?"
 */
    ...
    >
      ...
      >
        ...
        <div className="flex justify-end gap-2">
          ...
          <button className={confirmCls} onClick={onConfirm} disabled={busy}>
